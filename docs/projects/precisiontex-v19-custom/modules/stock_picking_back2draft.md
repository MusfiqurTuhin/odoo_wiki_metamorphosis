      ---
      technical_name: stock_picking_back2draft
      display_name: "Pickings back to draft"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Reopen cancelled pickings"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/stock_picking_back2draft
        branch: main
      contributors:
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `stock_picking_back2draft` |
        | Current version | `19.0.1.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/stock_picking_back2draft` |
