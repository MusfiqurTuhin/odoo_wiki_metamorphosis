    ...
    display_name: "Impresión de etiquetas ZPL"
    project_slug: precisiontex-v19-custom
    curated: false
    reusable: false
    marketing_summary: "Base para la impresión de etiquetas de productos"
    odoo_version: "19.0"
    category: TBD
    git:
      repo_url: ""
      path: precisiontex-v19-custom/product_label
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
Base para la impresión de etiquetas de productos
...
| Field | Value |
|-------|-------|
| Technical name | `product_label` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/product_label` |
