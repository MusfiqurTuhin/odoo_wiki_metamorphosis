      ---
      technical_name: date_range
      display_name: "Date Range"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Manage all kind of date range"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/date_range
        branch: main
      contributors:
        - name: "ACSONE SA/NV"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `date_range` |
        | Current version | `19.0.2.2.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/date_range` |
        ...
        |---------|------|------------|
        | 19.0.2.2.0 | 2026-06-13 | Seeded from scan — add release notes |
