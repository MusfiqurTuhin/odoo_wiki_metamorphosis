      ---
      technical_name: account_payment_purchase
      display_name: "Account Payment Purchase"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Adds Bank Account and Payment Mode on Purchase Orders"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_payment_purchase
        branch: main
      contributors:
        - name: "Akretion"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_payment_purchase` |
        | Current version | `19.0.1.0.5` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_payment_purchase` |
        ...
        |---------|------|------------|
        | 19.0.1.0.5 | 2026-06-13 | Seeded from scan — add release notes |
