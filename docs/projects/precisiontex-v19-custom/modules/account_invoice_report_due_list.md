      ---
      technical_name: account_invoice_report_due_list
      display_name: "Account Invoice Report Due List"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Show multiple due data in invoice"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_invoice_report_due_list
        branch: main
      contributors:
        - name: "Tecnativa"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_invoice_report_due_list` |
        | Current version | `19.0.2.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_invoice_report_due_list` |
        | Manifest author | Tecnativa, Odoo Community Association (OCA) |
