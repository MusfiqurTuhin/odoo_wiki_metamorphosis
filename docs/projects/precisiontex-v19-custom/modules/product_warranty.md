    ---
    technical_name: product_warranty
    display_name: "Product Warranty"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/product_warranty
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `product_warranty` |
| Current version | `19.0.3.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/product_warranty` |
