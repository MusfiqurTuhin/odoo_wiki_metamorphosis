      ---
      technical_name: website_odoo_debranding
      display_name: "Remove Odoo Branding from Website"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/website_odoo_debranding
        branch: main
      contributors:
        - name: "Tecnativa"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `website_odoo_debranding` |
        | Current version | `19.0.1.1.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/website_odoo_debranding` |
