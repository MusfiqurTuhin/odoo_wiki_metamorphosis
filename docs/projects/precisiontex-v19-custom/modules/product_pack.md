      ---
      technical_name: product_pack
      display_name: "Product Pack"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "This module allows you to set a product as a Pack"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/product_pack
        branch: main
      contributors:
        - name: "NaN·tic"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `product_pack` |
        | Current version | `19.0.1.1.2` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/product_pack` |
