      ---
      technical_name: account_balance_line
      display_name: "Balance on journal items"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Display balance totals in move line view"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_balance_line
        branch: main
      contributors:
        - name: "Camptocamp"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_balance_line` |
        | Current version | `19.0.1.1.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_balance_line` |
