    ---
    technical_name: purchase_extension
    display_name: "Purchase Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/purchase_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `purchase_extension` |
| Current version | `19.0.1.1.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/purchase_extension` |
