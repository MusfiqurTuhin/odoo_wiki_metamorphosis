    ---
    technical_name: product_qty_base
    display_name: "Cantidades stock"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/product_qty_base
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `product_qty_base` |
| Current version | `19.0.1.2.9` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/product_qty_base` |
...
|---------|------|------------|
| 19.0.1.2.9 | 2026-06-13 | Seeded from scan — add release notes |
