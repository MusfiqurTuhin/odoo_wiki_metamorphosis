    ---
    technical_name: sale_commission_oca
    display_name: "sale_commission_oca"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/sale_commission_oca
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `sale_commission_oca` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/sale_commission_oca` |
