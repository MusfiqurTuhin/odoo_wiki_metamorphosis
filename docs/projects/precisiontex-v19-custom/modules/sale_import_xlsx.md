    ---
    technical_name: sale_import_xlsx
    display_name: "Sale Import XLSX"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/sale_import_xlsx
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `sale_import_xlsx` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/sale_import_xlsx` |
