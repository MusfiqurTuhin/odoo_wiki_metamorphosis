      ---
      technical_name: account_financial_risk
      display_name: "Account Financial Risk"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Manage customer risk"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_financial_risk
        branch: main
      contributors:
        - name: "Tecnativa"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_financial_risk` |
        | Current version | `19.0.2.2.1` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_financial_risk` |
        ...
        |---------|------|------------|
        | 19.0.2.2.1 | 2026-06-13 | Seeded from scan — add release notes |
