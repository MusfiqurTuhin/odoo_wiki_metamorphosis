    ---
    technical_name: sale_amazon_labels
    display_name: "Sale Amazon Labels"
    project_slug: precisiontex-v19-custom
    curated: false
    reusable: false
    marketing_summary: "Añade método de envío Amazon"
    odoo_version: "19.0"
    category: TBD
    git:
      repo_url: ""
      path: precisiontex-v19-custom/sale_amazon_labels
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `sale_amazon_labels` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/sale_amazon_labels` |
