      ---
      technical_name: report_xlsx_helper
      display_name: "Report xlsx helpers"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/report_xlsx_helper
        branch: main
      contributors:
        - name: "Noviat"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `report_xlsx_helper` |
        | Current version | `19.0.1.0.2` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/report_xlsx_helper` |
        | Manifest author | Noviat, Odoo Community Association (OCA) |
