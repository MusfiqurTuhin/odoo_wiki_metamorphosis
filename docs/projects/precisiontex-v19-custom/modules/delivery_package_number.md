      ---
      technical_name: delivery_package_number
      display_name: "Stock Picking Package Number"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Set or compute number of packages for a picking"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/delivery_package_number
        branch: main
      contributors:
        - name: "Tecnativa"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `delivery_package_number` |
        | Current version | `19.0.1.2.1` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/delivery_package_number` |
        ...
        |---------|------|------------|
        | 19.0.1.2.1 | 2026-06-13 | Seeded from scan — add release notes |
