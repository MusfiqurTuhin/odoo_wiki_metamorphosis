    ---
    technical_name: sale_extension
    display_name: "Sale Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/sale_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `sale_extension` |
| Current version | `19.0.1.2.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/sale_extension` |
