    ---
    technical_name: report_layout_base
    display_name: "Report Layout Base"
    project_slug: precisiontex-v19-custom
    curated: false
    reusable: false
    marketing_summary: "Layouts estándar para informes personalizados"
    odoo_version: "19.0"
    category: TBD
    git:
      repo_url: ""
      path: precisiontex-v19-custom/report_layout_base
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `report_layout_base` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/report_layout_base` |
