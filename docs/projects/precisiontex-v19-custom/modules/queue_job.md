      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/queue_job
        branch: main
      contributors:
        - name: "Camptocamp"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Git path | `precisiontex-v19-custom/queue_job` |
        | Manifest author | Camptocamp,ACSONE SA/NV,Odoo Community Association (OCA) |
