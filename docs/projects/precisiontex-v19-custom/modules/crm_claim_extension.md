    ---
    technical_name: crm_claim_extension
    display_name: "CRM Claim Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/crm_claim_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `crm_claim_extension` |
| Current version | `19.0.2.3.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/crm_claim_extension` |
...
|---------|------|------------|
| 19.0.2.3.0 | 2026-06-13 | Seeded from scan — add release notes |
