      ---
      technical_name: stock_quant_package_product_packaging
      display_name: "Stock Quant Package Product Packaging"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Use product packagings on packages"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/stock_quant_package_product_packaging
        branch: main
      contributors:
        - name: "Camptocamp"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `stock_quant_package_product_packaging` |
        | Current version | `19.0.1.1.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/stock_quant_package_product_packaging` |
