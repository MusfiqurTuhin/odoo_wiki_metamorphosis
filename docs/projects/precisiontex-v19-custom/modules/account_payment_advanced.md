    ---
    technical_name: account_payment_advanced
    display_name: "Account Payment Advanced"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/account_payment_advanced
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `account_payment_advanced` |
| Current version | `19.0.2.2.2` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/account_payment_advanced` |
...
|---------|------|------------|
| 19.0.2.2.2 | 2026-06-13 | Seeded from scan — add release notes |
