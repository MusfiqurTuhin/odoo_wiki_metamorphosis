    ---
    technical_name: repair_report
    display_name: "Repair Report"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/repair_report
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `repair_report` |
| Current version | `19.0.2.1.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/repair_report` |
