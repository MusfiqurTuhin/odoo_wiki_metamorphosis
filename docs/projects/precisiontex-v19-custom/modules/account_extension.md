    ---
    technical_name: account_extension
    display_name: "Account Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/account_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `account_extension` |
| Current version | `19.0.1.2.2` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/account_extension` |
