    ---
    technical_name: product_extension
    display_name: "Product Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/product_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `product_extension` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/product_extension` |
