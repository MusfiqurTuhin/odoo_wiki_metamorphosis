    ---
    technical_name: repair_report_banner
    display_name: "Repair Report Banner"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/repair_report_banner
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
# Repair Report Banner

`repair_report_banner`
...
| Field | Value |
|-------|-------|
| Technical name | `repair_report_banner` |
| Current version | `19.0.1.0.1` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/repair_report_banner` |
