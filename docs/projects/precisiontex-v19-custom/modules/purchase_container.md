    ---
    technical_name: purchase_container
    display_name: "Gestión de contenedores"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/purchase_container
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `purchase_container` |
| Current version | `19.0.1.5.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/purchase_container` |
...
|---------|------|------------|
| 19.0.1.5.0 | 2026-06-13 | Seeded from scan — add release notes |
