      ---
      technical_name: sql_export_mail
      display_name: "SQL Export Mail"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Send csv file generated by sql query by mail."
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/sql_export_mail
        branch: main
      contributors:
        - name: "Akretion"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `sql_export_mail` |
        | Current version | `19.0.1.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/sql_export_mail` |
