      ---
      technical_name: delivery_dhl_parcel
      display_name: "Delivery DHL Parcel"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Delivery Carrier implementation for DHL Parcel using their API"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/delivery_dhl_parcel
        branch: main
      contributors:
        - name: "Studio73"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `delivery_dhl_parcel` |
        | Current version | `19.0.2.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/delivery_dhl_parcel` |
        | Manifest author | Studio73, Odoo Community Association (OCA) |
