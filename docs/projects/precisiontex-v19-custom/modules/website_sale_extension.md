    ---
    technical_name: website_sale_extension
    display_name: "Website Sale Extension"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/website_sale_extension
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `website_sale_extension` |
| Current version | `19.0.1.6.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/website_sale_extension` |
...
|---------|------|------------|
| 19.0.1.6.0 | 2026-06-13 | Seeded from scan — add release notes |
