      ---
      technical_name: product_analytic_purchase
      display_name: "Product Analytic Purchase"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Glue module between purchase and product_analytic"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/product_analytic_purchase
        branch: main
      contributors:
        - name: "Akretion"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `product_analytic_purchase` |
        | Current version | `19.0.1.0.1` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/product_analytic_purchase` |
