      ---
      technical_name: account_payment_mode
      display_name: "Account Payment Mode"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_payment_mode
        branch: main
      contributors:
        - name: "Akretion"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_payment_mode` |
        | Current version | `19.0.1.1.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_payment_mode` |
