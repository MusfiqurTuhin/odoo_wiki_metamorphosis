    ---
    technical_name: account_code_shortcut
    display_name: "Buscar cuentas con atajos"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/account_code_shortcut
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `account_code_shortcut` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/account_code_shortcut` |
