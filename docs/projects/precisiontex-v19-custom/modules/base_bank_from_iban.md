      ---
      technical_name: base_bank_from_iban
      display_name: "Bank from IBAN"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/base_bank_from_iban
        branch: main
      contributors:
        - name: "Tecnativa"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `base_bank_from_iban` |
        | Current version | `19.0.1.0.2` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/base_bank_from_iban` |
