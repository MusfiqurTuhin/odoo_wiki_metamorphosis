    ---
    technical_name: account_analytic_default_account
    display_name: "Account Analytic Default Account"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/account_analytic_default_account
      branch: main
    contributors:
...
`account_analytic_default_account`
...
| Field | Value |
|-------|-------|
| Technical name | `account_analytic_default_account` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/account_analytic_default_account` |
| Manifest author | Odoo Community Association (OCA) |
