      ---
      technical_name: account_invoice_refund_link
      display_name: "Show links between refunds and their originator invoices"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_invoice_refund_link
        branch: main
      contributors:
        - name: "Pexego"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_invoice_refund_link` |
        | Current version | `19.0.1.0.5` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_invoice_refund_link` |
        | Manifest author | Pexego, Tecnativa, Odoo Community Association (OCA) |
