      ---
      technical_name: monitoring_status
      display_name: "Monitoring: Status"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/monitoring_status
        branch: main
      contributors:
        - name: "Camptocamp"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `monitoring_status` |
        | Current version | `19.0.1.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/monitoring_status` |
        | Manifest author | Camptocamp,Studio73,Odoo Community Association (OCA) |
