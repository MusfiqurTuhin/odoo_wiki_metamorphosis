      ---
      technical_name: product_net_weight
      display_name: "Products - Net Weight"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Add 'Net Weight' on product models"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/product_net_weight
        branch: main
      contributors:
        - name: "GRAP"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `product_net_weight` |
        | Current version | `19.0.1.0.1` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/product_net_weight` |
        | Manifest author | GRAP,Odoo Community Association (OCA) |
