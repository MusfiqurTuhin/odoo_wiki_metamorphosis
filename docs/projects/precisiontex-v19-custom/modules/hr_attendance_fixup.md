    ---
    technical_name: hr_attendance_fixup
    display_name: "HR Attendance Fixup"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/hr_attendance_fixup
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `hr_attendance_fixup` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/hr_attendance_fixup` |
