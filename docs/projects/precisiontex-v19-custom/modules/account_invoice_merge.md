      ---
      technical_name: account_invoice_merge
      display_name: "Account Invoice Merge"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Merge invoices in draft"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_invoice_merge
        branch: main
      contributors:
        - name: "Elico Corp"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Git path | `precisiontex-v19-custom/account_invoice_merge` |
        | Manifest author | Elico Corp,Odoo Community Association (OCA) |
