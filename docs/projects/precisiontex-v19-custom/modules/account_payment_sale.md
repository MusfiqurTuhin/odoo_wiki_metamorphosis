      ---
      technical_name: account_payment_sale
      display_name: "Account Payment Sale"
      project_slug: precisiontex-v19-custom
      curated: false
      reusable: false
      marketing_summary: "Adds payment mode on sale orders"
      odoo_version: "19.0"
      category: TBD
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_payment_sale
        branch: main
      contributors:
        - name: "Akretion"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_payment_sale` |
        | Current version | `19.0.1.1.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_payment_sale` |
