    ---
    technical_name: account_move_unlink
    display_name: "Account Move Unlink"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/account_move_unlink
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `account_move_unlink` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/account_move_unlink` |
