    ---
    technical_name: purchase_push_link
    display_name: "Purchase push link"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/purchase_push_link
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `purchase_push_link` |
| Current version | `19.0.1.0.4` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/purchase_push_link` |
...
|---------|------|------------|
| 19.0.1.0.4 | 2026-06-13 | Seeded from scan — add release notes |
