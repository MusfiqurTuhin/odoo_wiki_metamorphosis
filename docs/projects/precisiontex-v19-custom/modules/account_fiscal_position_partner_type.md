      ---
      technical_name: account_fiscal_position_partner_type
      display_name: "Account Fiscal Position Partner Type"
      ...
      git:
        repo_url: ""
        path: precisiontex-v19-custom/account_fiscal_position_partner_type
        branch: main
      contributors:
        - name: "Sygel Technology"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Field | Value |
        |-------|-------|
        | Technical name | `account_fiscal_position_partner_type` |
        | Current version | `19.0.1.0.0` |
        | Project | [Precisiontex](../index.md) |
        | Git path | `precisiontex-v19-custom/account_fiscal_position_partner_type` |
        | Manifest author | Sygel Technology,Odoo Community Association (OCA) |
