    ---
    technical_name: efectos_comerciales
    display_name: "Efectos comerciales"
    ...
    git:
      repo_url: ""
      path: precisiontex-v19-custom/efectos_comerciales
      branch: main
    contributors:
      - name: "Studio73"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `efectos_comerciales` |
| Current version | `19.0.1.0.0` |
| Project | [Precisiontex](../index.md) |
| Git path | `precisiontex-v19-custom/efectos_comerciales` |
