    ---
    technical_name: hr_rostering
    display_name: "HR Rostering"
    ...
    git:
      repo_url: ""
      path: friendship_ngo_sh/hr_rostering
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `hr_rostering` |
| Current version | `17.0.1.0.0` |
| Project | [Friendship NGO](../index.md) |
| Git path | `friendship_ngo_sh/hr_rostering` |
