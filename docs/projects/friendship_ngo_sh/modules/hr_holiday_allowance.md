    ---
    technical_name: hr_holiday_allowance
    display_name: "HR Holiday Allowance"
    project_slug: friendship_ngo_sh
    curated: false
    reusable: false
    marketing_summary: "This module enables employee Holiday Allowance"
    odoo_version: "17.0"
    category: TBD
    git:
      repo_url: ""
      path: friendship_ngo_sh/hr_holiday_allowance
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `hr_holiday_allowance` |
| Current version | `17.0.1.0.0` |
| Project | [Friendship NGO](../index.md) |
| Git path | `friendship_ngo_sh/hr_holiday_allowance` |
