    ---
    technical_name: meta_tv_contract
    display_name: "Television Contract"
    project_slug: odoo16-custom-addons
    curated: false
    reusable: true
    marketing_summary: "Marketplace API Integration"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: odoo16-custom-addons/meta_tv_contract
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_tv_contract` |
| Current version | `1.0` |
| Project | [Odoo16 Custom Addons](../index.md) |
| Git path | `odoo16-custom-addons/meta_tv_contract` |
| Manifest author | N/A |
