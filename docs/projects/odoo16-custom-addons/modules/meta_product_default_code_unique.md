    ---
    technical_name: meta_product_default_code_unique
    display_name: "Product Internal Reference Unique"
    project_slug: odoo16-custom-addons
    curated: false
    reusable: true
    marketing_summary: "Unique internal reference (SKU)."
    odoo_version: "16.0"
    category: TBD
    git:
      repo_url: ""
      path: odoo16-custom-addons/meta_product_default_code_unique
      branch: main
    contributors:
...
`meta_product_default_code_unique`
...
| Field | Value |
|-------|-------|
| Technical name | `meta_product_default_code_unique` |
| Current version | `16.0.0.1` |
| Project | [Odoo16 Custom Addons](../index.md) |
| Git path | `odoo16-custom-addons/meta_product_default_code_unique` |
