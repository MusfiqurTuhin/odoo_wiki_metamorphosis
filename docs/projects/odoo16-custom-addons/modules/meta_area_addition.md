    ---
    technical_name: meta_area_addition
    display_name: "Area, Sub Area fields addition"
    ...
    git:
      repo_url: ""
      path: odoo16-custom-addons/meta_area_addition
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_area_addition` |
| Current version | `1.0` |
| Project | [Odoo16 Custom Addons](../index.md) |
| Git path | `odoo16-custom-addons/meta_area_addition` |
| Manifest author | N/A |
