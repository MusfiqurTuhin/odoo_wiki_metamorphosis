    ---
    technical_name: meta_whatsapp_floating_button
    display_name: "meta_whatsapp_floating_button"
    ...
    git:
      repo_url: ""
      path: odoo16-custom-addons/meta_whatsapp_floating_button
      branch: main
    contributors:
      - name: "My Company"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_whatsapp_floating_button` |
| Current version | `0.1` |
| Project | [Odoo16 Custom Addons](../index.md) |
| Git path | `odoo16-custom-addons/meta_whatsapp_floating_button` |
