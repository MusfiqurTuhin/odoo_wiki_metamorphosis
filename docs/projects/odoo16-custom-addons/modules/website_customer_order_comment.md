    ---
    technical_name: website_customer_order_comment
    display_name: "Customer Order Comment"
    project_slug: odoo16-custom-addons
    curated: false
    reusable: false
    marketing_summary: "Know your customer's comments, view it on checkout page"
    odoo_version: "16.0"
    category: TBD
    git:
      repo_url: ""
      path: odoo16-custom-addons/website_customer_order_comment
      branch: main
    contributors:
      - name: "AppJetty"
role: author
...
`website_customer_order_comment`
...
| Field | Value |
|-------|-------|
| Technical name | `website_customer_order_comment` |
| Current version | `16.0.1.0.0` |
| Project | [Odoo16 Custom Addons](../index.md) |
| Git path | `odoo16-custom-addons/website_customer_order_comment` |
| Manifest author | AppJetty |
