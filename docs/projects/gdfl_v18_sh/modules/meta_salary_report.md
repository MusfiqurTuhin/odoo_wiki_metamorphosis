    ---
    technical_name: meta_salary_report
    display_name: "Salary Report"
    ...
    git:
      repo_url: ""
      path: gdfl_v18_sh/meta_salary_report
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_salary_report` |
| Current version | `18.0.0.1` |
| Project | [GDFL](../index.md) |
| Git path | `gdfl_v18_sh/meta_salary_report` |
