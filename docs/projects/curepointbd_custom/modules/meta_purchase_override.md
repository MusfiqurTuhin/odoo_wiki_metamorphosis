    ---
    technical_name: meta_purchase_override
    display_name: "Purchase Override"
    project_slug: curepointbd_custom
    curated: false
    reusable: true
    marketing_summary: "Override Purchase Order"
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
      path: curepointbd_custom/meta_purchase_override
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_purchase_override` |
| Current version | `0.1` |
| Project | [Curepoint BD](../index.md) |
| Git path | `curepointbd_custom/meta_purchase_override` |
