    ---
    technical_name: mass_mailing_crm
    display_name: "Mass mailing on lead / opportunities"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Add lead / opportunities UTM info on mass mailing"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/mass_mailing_crm
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `mass_mailing_crm` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/mass_mailing_crm` |
| Manifest author | N/A |
