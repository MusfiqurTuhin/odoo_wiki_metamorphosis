    ---
    technical_name: hr_timesheet_attendance
    display_name: "Timesheets/attendances reporting"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Module linking the attendance module to the timesheet app."
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/hr_timesheet_attendance
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Git path | `basb/hr_timesheet_attendance` |
| Manifest author | N/A |
