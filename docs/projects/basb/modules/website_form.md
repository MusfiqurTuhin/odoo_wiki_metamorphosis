    ---
    technical_name: website_form
    display_name: "Generic Form Controller"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Generic controller for web forms"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/website_form
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `website_form` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/website_form` |
| Manifest author | N/A |
