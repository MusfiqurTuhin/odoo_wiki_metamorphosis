    ---
    technical_name: barcodes
    display_name: "Barcode"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Barcodes Scanning and Parsing"
    odoo_version: "2.0"
    category: TBD
    git:
      repo_url: ""
...
|---------|------|------------|
| 2.0 | 2026-06-13 | Seeded from scan — add release notes |
