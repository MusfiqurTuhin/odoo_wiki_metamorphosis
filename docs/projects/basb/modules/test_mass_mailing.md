    ---
    technical_name: test_mass_mailing
    display_name: "Mass Mail Tests"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Mass Mail Tests: feature and performance tests for mass mailing"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/test_mass_mailing
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `test_mass_mailing` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/test_mass_mailing` |
| Manifest author | N/A |
