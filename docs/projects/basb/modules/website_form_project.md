    ---
    technical_name: website_form_project
    display_name: "Online Task Submission"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Add a task suggestion form to your website"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/website_form_project
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `website_form_project` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/website_form_project` |
| Manifest author | N/A |
