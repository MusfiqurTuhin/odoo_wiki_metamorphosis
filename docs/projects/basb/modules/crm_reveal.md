    ---
    technical_name: crm_reveal
    display_name: "Lead Generation"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Create Leads/Opportunities from your website's traffic"
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
      path: basb/crm_reveal
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `crm_reveal` |
| Current version | `N/A` |
| Project | [Basb](../index.md) |
| Git path | `basb/crm_reveal` |
| Manifest author | N/A |
