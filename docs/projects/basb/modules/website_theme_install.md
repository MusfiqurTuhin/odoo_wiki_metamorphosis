    ---
    technical_name: website_theme_install
    display_name: "Website Theme Install"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Select a theme for your website"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/website_theme_install
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `website_theme_install` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/website_theme_install` |
| Manifest author | N/A |
