    ---
    technical_name: hr_expense_check
    display_name: "Check Printing in Expenses"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Print amount in words on checks issued for expenses"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/hr_expense_check
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `hr_expense_check` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/hr_expense_check` |
| Manifest author | N/A |
