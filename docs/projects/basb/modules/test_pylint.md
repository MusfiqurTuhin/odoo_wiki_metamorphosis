    ---
    technical_name: test_pylint
    display_name: "test-eval"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Deprecated empty module in favor of test-lint."
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
      path: basb/test_pylint
      branch: main
    contributors:
      - name: "TBD"
role: author
...
Deprecated empty module in favor of test-lint.
...
| Field | Value |
|-------|-------|
| Technical name | `test_pylint` |
| Current version | `0.1` |
| Project | [Basb](../index.md) |
| Git path | `basb/test_pylint` |
| Manifest author | N/A |
