    ---
    technical_name: test_exceptions
    display_name: "test-exceptions"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "A module to generate exceptions."
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
      path: basb/test_exceptions
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `test_exceptions` |
| Current version | `0.1` |
| Project | [Basb](../index.md) |
| Git path | `basb/test_exceptions` |
| Manifest author | N/A |
