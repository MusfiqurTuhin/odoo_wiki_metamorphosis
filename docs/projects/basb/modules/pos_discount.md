    ---
    technical_name: pos_discount
    display_name: "Point of Sale Discounts"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Simple Discounts in the Point of Sale"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/pos_discount
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `pos_discount` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/pos_discount` |
| Manifest author | N/A |
