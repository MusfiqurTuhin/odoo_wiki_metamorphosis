    ---
    technical_name: test_uninstall
    display_name: "test-uninstall"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "A module to test the uninstall feature."
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
      path: basb/test_uninstall
      branch: main
    contributors:
      - name: "TBD"
role: author
...
A module to test the uninstall feature.
...
| Field | Value |
|-------|-------|
| Technical name | `test_uninstall` |
| Current version | `0.1` |
| Project | [Basb](../index.md) |
| Git path | `basb/test_uninstall` |
| Manifest author | N/A |
