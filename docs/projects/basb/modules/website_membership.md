    ---
    technical_name: website_membership
    display_name: "Online Members Directory"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Publish your members directory"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/website_membership
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `website_membership` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/website_membership` |
| Manifest author | N/A |
