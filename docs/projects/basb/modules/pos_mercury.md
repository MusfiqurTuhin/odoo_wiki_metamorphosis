    ---
    technical_name: pos_mercury
    display_name: "Mercury Payment Services"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Credit card support for Point Of Sale"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/pos_mercury
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `pos_mercury` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/pos_mercury` |
| Manifest author | N/A |
