    ---
    technical_name: website_payment
    display_name: "Website Payment"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Payment integration with website"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/website_payment
      branch: main
    contributors:
      - name: "TBD"
role: author
