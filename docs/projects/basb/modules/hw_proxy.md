    ---
    technical_name: hw_proxy
    display_name: "Hardware Proxy"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Connect the Web Client to Hardware Peripherals"
    odoo_version: "TBD"
    category: TBD
    git:
      repo_url: ""
...
| Field | Value |
|-------|-------|
| Technical name | `hw_proxy` |
| Current version | `N/A` |
| Project | [Basb](../index.md) |
| Git path | `basb/hw_proxy` |
| Manifest author | N/A |
