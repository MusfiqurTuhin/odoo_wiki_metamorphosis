    ---
    technical_name: stock_picking_batch
    display_name: "Warehouse Management: Batch Picking"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "This module adds the batch picking option in warehouse management ================================================================="
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/stock_picking_batch
      branch: main
    contributors:
      - name: "TBD"
role: author
...
# Warehouse Management: Batch Picking
...
| Git path | `basb/stock_picking_batch` |
| Manifest author | N/A |
