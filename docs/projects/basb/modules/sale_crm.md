    ---
    technical_name: sale_crm
    display_name: "Opportunity to Quotation"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "This module adds a shortcut on one or several opportunity cases in the CRM. ========================================================================="
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
