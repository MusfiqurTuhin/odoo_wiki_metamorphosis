    ---
    technical_name: sale_stock
    display_name: "Sales and Warehouse Management"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Quotation, Sales Orders, Delivery & Invoicing Control"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/sale_stock
      branch: main
    contributors:
      - name: "TBD"
role: author
