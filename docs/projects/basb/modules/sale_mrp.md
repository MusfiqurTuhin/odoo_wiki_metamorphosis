    ---
    technical_name: sale_mrp
    display_name: "Sales and MRP Management"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "This module provides facility to the user to install mrp and sales modulesat a time. ================================================================"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
