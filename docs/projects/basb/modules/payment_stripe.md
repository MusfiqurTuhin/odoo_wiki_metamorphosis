    ---
    technical_name: payment_stripe
    display_name: "Stripe Payment Acquirer"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Payment Acquirer: Stripe Implementation"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/payment_stripe
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `payment_stripe` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/payment_stripe` |
| Manifest author | N/A |
