    ---
    technical_name: payment_transfer
    display_name: "Transfer Payment Acquirer"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Payment Acquirer: Transfer Implementation"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/payment_transfer
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `payment_transfer` |
| Current version | `1.0` |
| Project | [Basb](../index.md) |
| Git path | `basb/payment_transfer` |
| Manifest author | N/A |
