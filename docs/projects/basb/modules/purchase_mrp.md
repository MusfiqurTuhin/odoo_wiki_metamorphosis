    ---
    technical_name: purchase_mrp
    display_name: "Purchase and MRP Management"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "This module provides facility to the user to install mrp and purchase modules at a time. ============================================================"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/purchase_mrp
      branch: main
    contributors:
      - name: "TBD"
role: author
