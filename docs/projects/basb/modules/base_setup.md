    ...
    display_name: "Initial Setup Tools"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "This module helps to configure the system at the installation of a new database. ===================================================================="
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/base_setup
      branch: main
    contributors:
      - name: "TBD"
role: author
