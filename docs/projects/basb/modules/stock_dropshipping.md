    ---
    technical_name: stock_dropshipping
    display_name: "Drop Shipping"
    project_slug: basb
    curated: false
    reusable: false
    marketing_summary: "Drop Shipping"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: basb/stock_dropshipping
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Git path | `basb/stock_dropshipping` |
| Manifest author | N/A |
