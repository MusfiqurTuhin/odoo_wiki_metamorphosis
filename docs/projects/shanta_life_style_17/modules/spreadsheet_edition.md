    ---
    technical_name: spreadsheet_edition
    display_name: "Spreadsheet"
    project_slug: shanta_life_style_17
    curated: false
    reusable: false
    marketing_summary: "Spreadsheet"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: shanta_life_style_17/spreadsheet_edition
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Git path | `shanta_life_style_17/spreadsheet_edition` |
| Manifest author | N/A |
