    ---
    technical_name: meta_track_order
    display_name: "Track Order"
    project_slug: organik-chicken
    curated: false
    reusable: true
    marketing_summary: "Use order number to track products."
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: organik-chicken/meta_track_order
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_track_order` |
| Current version | `1.0.0.0` |
| Project | [Organik Chicken](../index.md) |
| Git path | `organik-chicken/meta_track_order` |
