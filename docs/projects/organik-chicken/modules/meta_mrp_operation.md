    ---
    technical_name: meta_mrp_operation
    display_name: "Operation Type"
    project_slug: organik-chicken
    curated: false
    reusable: true
    marketing_summary: "Change the position of Operation type"
    odoo_version: "16.0"
    category: TBD
    git:
      repo_url: ""
      path: organik-chicken/meta_mrp_operation
      branch: main
    contributors:
      - name: "TBD"
role: author
...
Change the position of Operation type
...
| Field | Value |
|-------|-------|
| Technical name | `meta_mrp_operation` |
| Current version | `16.0.2.0.0` |
| Project | [Organik Chicken](../index.md) |
| Git path | `organik-chicken/meta_mrp_operation` |
