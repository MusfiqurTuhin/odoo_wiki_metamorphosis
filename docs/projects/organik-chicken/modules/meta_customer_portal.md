    ---
    technical_name: meta_customer_portal
    display_name: "Customer Portal"
    project_slug: organik-chicken
    curated: false
    reusable: true
    marketing_summary: "Customize Customer man portal ...."
    odoo_version: "16.0"
    category: TBD
    git:
      repo_url: ""
      path: organik-chicken/meta_customer_portal
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_customer_portal` |
| Current version | `16.0.2.0.0` |
| Project | [Organik Chicken](../index.md) |
| Git path | `organik-chicken/meta_customer_portal` |
