    ...
    curated: false
    reusable: true
    marketing_summary: "Create customer custom fields (Facebook ID, WhatsApp Number, Bkash Number, Nagad Number, Is Delivery Man,         Is Subscriber, subscription"
    odoo_version: "16.0"
    category: TBD
    git:
      repo_url: ""
      path: organik-chicken/meta_customer_fields
      branch: main
    contributors:
      - name: "TBD"
role: author
...
Create customer custom fields (Facebook ID, WhatsApp Number, Bkash Number, Nagad Number, Is Delivery Man,         Is Subscriber, subscription
...
| Git path | `organik-chicken/meta_customer_fields` |
