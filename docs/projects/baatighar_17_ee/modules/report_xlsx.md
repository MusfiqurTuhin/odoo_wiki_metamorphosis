      ...
      display_name: "Base report xlsx"
      project_slug: baatighar_17_ee
      curated: false
      reusable: false
      marketing_summary: "Base module to create xlsx report"
      odoo_version: "17.0"
      category: TBD
      git:
        repo_url: ""
        path: baatighar_17_ee/report_xlsx
        branch: main
      contributors:
        - name: "ACSONE SA/NV"
  role: author
...
| Odoo Community Association (OCA) | author |
        ...
        | Git path | `baatighar_17_ee/report_xlsx` |
        | Manifest author | ACSONE SA/NV,Creu Blanca,Odoo Community Association (OCA) |
