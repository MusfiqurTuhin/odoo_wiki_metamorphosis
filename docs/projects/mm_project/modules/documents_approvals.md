    ---
    technical_name: documents_approvals
    display_name: "Documents - Approvals"
    project_slug: mm_project
    curated: false
    reusable: false
    marketing_summary: "Approval from documents"
    odoo_version: "1.0"
    category: TBD
    git:
      repo_url: ""
      path: mm_project/documents_approvals
      branch: main
    contributors:
      - name: "TBD"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `documents_approvals` |
| Current version | `1.0` |
| Project | [Mm Project](../index.md) |
| Git path | `mm_project/documents_approvals` |
| Manifest author | N/A |
