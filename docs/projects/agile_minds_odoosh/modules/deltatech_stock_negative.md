      ...
      git:
        repo_url: ""
        path: agile_minds_odoosh/deltatech_stock_negative
        branch: main
      contributors:
        - name: "Terrabit"
  role: author
...
| Dorin Hongu | author |
        ...
        | Current version | `17.0.2.0.4` |
        | Project | [Agile Minds](../index.md) |
        | Git path | `agile_minds_odoosh/deltatech_stock_negative` |
        ...
        |---------|------|------------|
        | 17.0.2.0.4 | 2026-06-13 | Seeded from scan — add release notes |
