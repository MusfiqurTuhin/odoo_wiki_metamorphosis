    ---
    technical_name: meta_fleet_custo
    display_name: "meta_fleet_custo"
    ...
    git:
      repo_url: ""
      path: nice_software/meta_fleet_custo
      branch: main
    contributors:
      - name: "My Company"
role: author
...
| Field | Value |
|-------|-------|
| Technical name | `meta_fleet_custo` |
| Current version | `0.1` |
| Project | [Nice Software](../index.md) |
| Git path | `nice_software/meta_fleet_custo` |
